...
- **Type:** Static site (HTML/CSS/JS) using the **Eventify** theme by *alithemes* with Bootstrap and jQuery.
...
- **Backend API base:** Endpoints point to `https://iccict-api.onrender.com/`.
...
| `admin/adminDashboard.html` | Admin Dashboard | ICCICT 2026 | http://localhost:5000/api, https://iccict-api.onrender.com/ | 3 | 4 | 1 |
| `admin/index.html` | Admin Login | ICCICT 2026 | https://iccict-api.onrender.com/ | 2 | 2 | 1 |
| `admin/superAdminDashboard.html` | Super Admin Dashboard | ICCICT 2026 | https://iccict-api.onrender.com/ | 4 | 9 | 1 |
| `agenda.html` | Conference Agenda | ICCICT 2026 | - | 11 | 18 | 1 |
| `code-of-conduct.html` | Code of Conduct - ICCICT 2026 | - | 11 | 18 | 1 |
| `contact.html` | Contact Us | ICCICT 2026 | https://iccict-api.onrender.com//contact | 11 | 18 | 1 |
...
| `index.html` | ICCICT 2026 | https://iccict-api.onrender.com//contact | 11 | 18 | 1 |
| `keynote-speaker-register.html` | ICCICT 2026 | http://localhost:5000/api/keynote-speaker/register, https://iccict-api.onrender.com//keynote-speaker/register | 11 | 18 | 1 |
| `paper-review.html` | Paper Review | ICCICT 2026 | https://iccict-api.onrender.com//speaker/speakers/${id}`); | 11 | 18 | 1 |
| `paper.html` | Paper Submission | ICCICT 2026 | https://iccict-api.onrender.com//speaker/register | 11 | 18 | 1 |
| `register.html` | Register | ICCICT 2026 | https://iccict-api.onrender.com//conference/register | 11 | 18 | 1 |
| `speakers.html` | Our Speakers | ICCICT 2026 | - | 11 | 18 | 1 |
| `sponsor-register.html` | Sponsor Register | ICCICT 2026 | https://iccict-api.onrender.com//sponsor/register | 11 | 18 | 1 |
...
- Detected `API_BASE` constants: https://iccict-api.onrender.com/
